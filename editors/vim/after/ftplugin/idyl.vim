...
function! s:ApplyIdylMappings()
  ...
  " z/r — pause / resume (z shadows fold prefix; r shadows replace-char)
...
let b:undo_ftplugin .= 'nunmap <buffer> t | iunmap <buffer> <C-e> | nunmap <buffer> s | nunmap <buffer> q | nunmap <buffer> z | nunmap <buffer> r | autocmd! IdylMappings'
