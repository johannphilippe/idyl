...
A temporal language for describing flow, and reactive behavior. \
...
The scheduler offers two mechanisms : non-deterministic high accuracy system clock, or audio clock synchronized with Xrune. 
